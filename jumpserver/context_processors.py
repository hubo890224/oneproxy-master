...
from omysql.models import MysqlServer
...
def name_proc(request):
    ...
    mysql_active_num = MysqlServer.objects.filter(is_active=True).count()
    mysql_total_num = MysqlServer.objects.all().count()
    ...
    info_dic = {'session_user_id': user_id,
                ...
                'mysql_active_num':mysql_active_num,
                'mysql_total_num':mysql_total_num,
                }
